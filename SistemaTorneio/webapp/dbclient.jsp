          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    <%String url = val(request, "url", "jdbc:derby:db;create=true");%>URL
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <%String sql = val(request, "sql");%>SQL
